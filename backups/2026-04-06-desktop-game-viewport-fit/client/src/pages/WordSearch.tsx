...
export default function WordSearch() {
  ...
  const boardWidthClassName =
    game.size >= 18
      ? "max-w-[min(100%,32rem)] sm:max-w-[35rem] lg:max-w-[37rem]"
      : game.size >= 14
        ? "max-w-[min(100%,28rem)] sm:max-w-[31rem] lg:max-w-[33rem]"
        : "max-w-[min(100%,24rem)] sm:max-w-[27rem] lg:max-w-[30rem]";
              ...
              >
                ...
                <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px]">
                  <div className="space-y-5">
                    ...
                    <div
                      className={cn(
                        "game-interactive-area protected-interactive relative mx-auto w-full touch-none",
                        boardWidthClassName
                      )}
